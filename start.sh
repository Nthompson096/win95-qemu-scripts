...
[[ ! -d /usr/share/win95 ]] 
mkdir /usr/share/win95 2> /dev/null && chmod +x ./*.sh && cp ./* /usr/share/win95 
...
#touch /usr/share/win95/ie95.iso
	...
	if  [[ -f /usr/share/win95/ie95.iso ]]; then 
			...
			echo "grabbing ie 95" && wget -c 'https://archive.org/download/ie4-win95-winnt/Internet%20Explorer%204.0%20for%20Windows%2095%20and%20NT%204.0.iso' -O /usr/share/win95/ie95.iso 2> /dev/null
