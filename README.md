...
3) ubuntu or debian: `sudo apt update && sudo apt upgrade -y && sudo apt install virt-manager qemu-system -y && git clone https://github.com/Nthompson096/win95-qemu-scripts.git && cd win95-qemu-scripts && sudo ./start.sh`
